...
export default function PR() {
  return (
    <motion.section className="flex flex-col items-center justify-center opacity-0" id="security" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}>
      <div className="flex flex-col md:flex-row items-center gap-24">
        <div className="flex-1 items-center justify-center w-full h-full border border-cyberyellow">Image</div>
        <div className="flex-1 flex flex-col gap-4">
          <h2 className="font-heading text-4xl md:text-6xl font-semibold">Public Relations</h2>
